...
func InitMapReduce(nmap int, nreduce int,
	...
	mr.Workers = make(map[string]*WorkerInfo, 100)
...
func (mr *MapReduce) Run() {
	...
	//fmt.Printf("now we are doing split!")
	mr.Split(mr.file) //split the file in different parts
	//fmt.Printf("start the RunMaster.")
